...
const FormProject = () => {
  ...
  return (
    <div className="py-44">
      <form
        class="max-w-md mx-auto p-5 rounded border-2 shadow-lg"
      ...
      >
        ...
        <div className="flex flex-row-reverse space-x-4 space-x-reverse">
          <button
            type="submit"
            class="text-black border-2 shadow-lg hover:bg-red-800 hover:text-white font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-red-800 dark:focus:ring-blue-800"
          >
            Submit
          </button>
        </div>
